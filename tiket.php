    ...
    <div class="container-fluid">
      ...
      <!-- Card Columns Example Social Feed-->
          ...
          <div class="card-columns">
            ...
            <div class="card mb-3">
              <a href="#">
                <img class="card-img-top img-fluid w-100" src="img/pesawatpromo.PNG" width="500" height="250">
              </a>
              <div class="card-body">
...
Bagi kamu pemilik kartu kredit BCA, HSBC, OCBC NISP, Permata Bank, Standard Chartered, UOB, CIMB Niaga, Citibank, BRI, Panin Bank, BNI, dan Bank Mandiri, semua bisa dicicil 0%
            ...
            <div class="card mb-3">
              <a href="#">
                <img class="card-img-top img-fluid w-100" src="img/hotelpromo.PNG" width="500" height="250">
              </a>
              <div class="card-body">
...
Bagi kamu pemilik kartu kredit BCA, HSBC, OCBC NISP, Permata Bank, Standard Chartered, UOB, CIMB Niaga, Citibank, BRI, Panin Bank, BNI, dan Bank Mandiri, semua bisa dicicil 0%
            ...
            <div class="card mb-3">
              <a href="#">
                <img class="card-img-top img-fluid w-100" src="img/liburanpromo.PNG" width="500" height="200">
              </a>
              <div class="card-body">
...
Kurang apa lagi? Yuk ciptakan kebahagiaan bersama, ajak temanmu keliling dunia, ke mana pun.                </p>
            ...
            <div class="card mb-3">
              <a href="#">
                <img class="card-img-top img-fluid w-100" src="img/keretapromo.PNG" width="500" height="250">
              </a>
              <div class="card-body">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white o-hidden h-100">
            <div class="card-body">
              ...
              <center><img src="img/citilink.png" alt="citilink" width="100" height="60"></center>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white o-hidden h-100">
            <div class="card-body">
              ...
              <center><img src="img/lionair.png" alt="lion air" width="100" height="60"></center>
            </div>
          </div>
        </div> 
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
               ...
               <center><img src="img/airasia.png" alt="air asia" width="100" height="60"></center>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white o-hidden h-100">
            <div class="card-body">
              ...
              <center><img src="img/garuda.jpg" alt="garuda" width="100" height="60"></center>
            </div>
          </div>
        </div>
      </div>
